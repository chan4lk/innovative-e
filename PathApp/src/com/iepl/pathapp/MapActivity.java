...
public class MapActivity extends Activity {
	...
	private class SlidePanelActionListener implements PanelSlideListener {
		...
		public void onPanelCollapsed(View panel) {
			map.getUiSettings().setScrollGesturesEnabled(true);
			MoveCamera(-(metrics.heightPixels/8),-(metrics.heightPixels/8));
		...
		public void onPanelAnchored(View panel) {
			...
			map.getUiSettings().setScrollGesturesEnabled(true);			
			MoveCamera(metrics.widthPixels/4, metrics.heightPixels/4);
	...
	{		
        ...
        mappoint.set(mappoint.x , mappoint.y + yOffset);
