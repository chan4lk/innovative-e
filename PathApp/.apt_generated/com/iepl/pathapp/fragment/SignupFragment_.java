...
public final class SignupFragment_
    extends SignupFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(layout.signup_layout, container, false);
        }
        return contentView_;
    }
    ...
    public static SignupFragment_.FragmentBuilder_ builder() {
        return new SignupFragment_.FragmentBuilder_();
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        SignupFragment_.this.onSignUpButtonPressed();
                    }
    ...
    public static class FragmentBuilder_ {
        ...
        public SignupFragment build() {
            SignupFragment_ fragment_ = new SignupFragment_();
